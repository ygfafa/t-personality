...
import { buttonWhileTapProps } from './ui/button'

type ShareFeatureProps = {
  kakao: ShareKakaoProps
  copy: ShareCopyProps
  className?: string
}
export const ShareFeature = ({ kakao, copy, className }: ShareFeatureProps) => {
  return (
    <section
...
export const ShareKakao = ({
  ...
  useEffect(() => {
    loadKakaoSdk('70bc257b42c0212d6ed128b9924d1122')
  }, [])
  ...
  return (
    <motion.button
      ...
      className="nb-shadow flex h-13 w-13 items-center justify-center overflow-hidden rounded-full bg-[#ffca28]"
    >
      <svg
